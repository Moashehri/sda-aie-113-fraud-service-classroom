...
@pytest.mark.unit
def test_merchant_category_is_normalized():
...
def test_night_flag():
    ...
    txn_night = Transaction(
        ...
        customer_id="cust-1",
        timestamp=datetime(2026, 1, 1, 5, 59, tzinfo=timezone.utc) # 05:59 AM is night
    )
    ...
    txn_day = Transaction(
        ...
        merchant_category="retail",
        customer_id="cust-1",
        timestamp=datetime(2026, 1, 1, 6, 0, tzinfo=timezone.utc) # 06:00 AM is day
    )
